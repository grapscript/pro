...
TIMES="10"
CHATID="196224851"
KEY="6866097221:AAFdDsbTF-R7_d07ewI3z0BQHYrd7QNhhA"
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/grapscript/regip/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/grapscript/pro/main/"
start=$(date +%s)
secs_to_human() {
...
if [[ -z "$nama" ]]; then
  echo "KANG SCRIPT" > /etc/xray/username
else
...
wget raw.githubusercontent.com/grapscript/pro/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "NOOBZVPNS BY KANG SCRIPT"
